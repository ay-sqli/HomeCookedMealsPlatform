    ...
    return( 
        ...
        <div className="Home-section">
                ...
                <div className="Welcome">
                    ...
                    <button className="bg-red-400 hover:bg-red-300 duration-500 text-white font-bold py-3 px-8 rounded-full">Explore more<MdOutlineArrowForwardIos style={{ fontSize: '1.3rem', marginLeft: '2px' }}/></button>
                </div>
                ...
                <div className="flex">
                    ...
                    <path d="M22.3593 2.46995C22.3593 0.00627682 19.1866 -0.922257 17.7891 1.1201C4.96875 19.8595 23.1875 20.7032 23.1875 29.8125C23.1875 33.5008 20.1741 36.4851 16.4745 36.4365C12.8339 36.3899 9.93749 33.3548 9.93749 29.7142V20.8626C9.93749 18.6163 7.19743 17.5263 5.64884 19.1546C2.87773 22.0654 0 27.0518 0 33.125C0 44.0842 8.91579 53 19.875 53C30.8342 53 39.75 44.0842 39.75 33.125C39.75 15.4974 22.3593 13.1465 22.3593 2.46995Z" fill="#F35151"/>
                        ...
                        <h2 className="px-2 py-2">Our Best Ranked Chef:</h2>
                    </div>
                    <div className="flex ">
                        ...
                        <div className="chef-profil img-5 m-1 outline outline-red-500 duration-500 hover:bg-gray-300 rounded-full mt-4 px-10 py-10 flex justify-center align-middle cursor-pointer"><span className="font-semibold text-xl relative bottom-3">+40</span></div>
                    </div>
                </div>
        </div>
 );
